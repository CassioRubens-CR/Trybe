// Crie um array ordenado pelos livros com mais de 60 anos de publicação 
...
function oldBooks() {
  const currentDate = new Date().getFullYear() - 60;
  const publicationYear = books
    .filter(year => year.releaseYear < currentDate)
